...
(function () {
  ...
  function setTab(mode) {
    ...
    var freeBtn = '<a class="ffbtn ffbtn-ghost" href="' + PAYHIP + esc(P.freeKey) +
      '" target="_blank" rel="noopener">' + ICON.down + P.freeLabel + '</a>';
    var premBtn = '<a class="ffbtn ffbtn-prem" href="' + PAYHIP + esc(P.premKey) +
      '" target="_blank" rel="noopener">' + ICON.spark + 'Get Premium · ' + esc(P.premPrice) + '</a>';
    ...
    if (mode === 'free') {
      ...
      bc.innerHTML =
        ...
        premBtn + freeBtn;
      bf.innerHTML = '<div class="ff-buy-fl">Premium adds</div>' +
  ...
  function renderVault() {
    ...
    wrap.innerHTML = SCRIPTS_IN.map(function (s, i) {
      ...
      return '<div class="ffdl-row">' +
        ...
        '<span class="ffdl-pill loc">' + esc(s.location) + '</span>' +
        '</span></span>' +
  ...
  /* =================================================================
     ...
     ================================================================= */
  function initBar() {
    if (!P.premKey || !P.freeKey) return;
    var bar = document.createElement('div');
    bar.className = 'ffbar';
    bar.innerHTML =
      '<span class="ffbar-pr"><span class="a">Premium</span><span class="b">' + esc(P.premPrice) + '</span></span>' +
      '<a class="ffbtn ffbtn-ghost" href="' + PAYHIP + esc(P.freeKey) + '" target="_blank" rel="noopener">Free</a>' +
      '<a class="ffbtn ffbtn-prem" href="' + PAYHIP + esc(P.premKey) + '" target="_blank" rel="noopener">Get Premium</a>';
